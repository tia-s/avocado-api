...
public class AvocadoGraphQLApi {
    ...
    @QueryMapping
    public List<AvocadoSale> getAvocadoSalesByType(@Argument String type) {
    ...
    @MutationMapping
    public AvocadoSale updateAvocadoSale(@Argument Long id, @Argument Map<String, Object> updates) {
