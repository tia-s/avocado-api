...
public class AvocadoSaleService {
    ...
    */
    ...
    public AvocadoSale updateAvocadoSale(Long id, Map<String, Object> updates) {
        ...
        Optional<AvocadoSale> existingSaleOpt = getAvocadoSaleById(id);
        ...
        if (existingSaleOpt.isPresent()) {
            ...
            // Save the updated sale data to the database
     ...
     * @return List of average prices for each region as list of RegionAveragePrice objects
    */
    @Transactional(readOnly = true)
